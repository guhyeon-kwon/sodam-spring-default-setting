        ...
        <div class="container-fluid">
            ...
            <div class="row clearfix">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="text-left">
                            <button type="button" class="btn btn-sm mb-1 btn-filter bg-default" data-target="all">전체</button>
                            <button type="button" class="btn btn-sm mb-1 btn-filter bg-green" data-target="approved">구매자</button>
                            <button type="button" class="btn btn-sm mb-1 btn-filter bg-orange" data-target="suspended">판매자</button>
                            <button type="button" class="btn btn-sm mb-1 btn-filter bg-azura" data-target="pending">상담사</button>
                            <button type="button" class="btn btn-sm mb-1 btn-filter bg-blush" data-target="blocked">관리자</button>
                        </div>
                        <table class="table table-hover table-custom spacing8 mb-0">
                            <tbody>
                                <tr data-status="approved">
                                    ...
                                    <td>
                                        <a href="javascript:void(0);" title="">판매자</a>
                                        <p class="mb-0">권구현</p>
                                    </td>
                                    <td>
